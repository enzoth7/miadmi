export function buildConsejos(params) {
  ...
  const tipCatalog = [
    ...
    { check: (c) => c.capacidadMensual > c.ingresosTotales * 0.4, message: "Podés guardar parte del margen mensual para ahorro de mediano plazo o para gastos futuros." },
    ...
    { check: (c) => c.ingresosTotales > 0 && c.egresosTotales <= c.ingresosTotales * 0.5, message: "Gastás menos de la mitad de lo que ganás. Podés destinar una parte al ahorro o a un fondo de emergencia." },
