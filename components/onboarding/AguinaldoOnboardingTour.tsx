...
const STORAGE_KEY = "miadmi:tour-herramienta-aguinaldo";
...
const STEPS: OnboardingStep[] = [
  {
    id: "mode-toggle",
    targetId: "aguinaldo-mode-toggle",
    title: "Veamos el aguinaldo",
    body: "Primero seleccioná si tu sueldo es fijo o variable. Si venís cobrando lo mismo todos los meses, usá sueldo fijo; si tus montos cambian de mes a mes, elegí sueldo variable para que el cálculo se adapte mejor a tu caso.",
  },
  {
    id: "inputs",
    targetId: "aguinaldo-inputs",
    title: "Completá tus datos para ver el aguinaldo",
    body: "En estos campos ingresás la información que usa la herramienta para estimar tu aguinaldo. Según lo que escribas acá, la app calcula una proyección del monto que podrías cobrar, usando las reglas habituales para Uruguay.",
  },
];
...
export function AguinaldoOnboardingTour({ onClose }: Props) {
